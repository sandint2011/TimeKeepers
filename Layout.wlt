...
MonoBehaviour:
  ...
  m_LastProjectPath: C:\Users\SandinTucker\OneDrive - University of Wisconsin-Stout\S9\Capstone\TimeKeepers
  m_LockTracker:
    m_IsLocked: 0
  m_FolderTreeState:
    scrollPos: {x: 0, y: 0}
    ...
    m_ExpandedIDs: ffffffff00000000185a0000f05a0000
    m_RenameOverlay:
      m_UserAcceptedRename: 0
      m_Name: 
      m_OriginalName: 
...
MonoBehaviour:
  ...
  m_SceneHierarchy:
    m_TreeViewState:
      ...
      m_SelectedIDs: 
      m_LastClickedID: 0
      m_ExpandedIDs: f2efffff34fbffff38fbffff
      m_RenameOverlay:
        m_UserAcceptedRename: 0
        m_Name: 
        m_OriginalName: 
...
MonoBehaviour:
  ...
  m_ZoomArea:
    ...
    m_HBaseRangeMin: -498.6
    m_HBaseRangeMax: 498.6
    m_VBaseRangeMin: -222.6
    m_VBaseRangeMax: 222.6
    ...
    m_Translation: {x: 498.59998, y: 222.6}
    m_MarginLeft: 0
    m_MarginRight: 0
    m_MarginTop: 0
    m_MarginBottom: 0
  ...
  m_LastWindowPixelSize: {x: 1246.5, y: 582.75}
  m_ClearInEditMode: 1
  m_NoCameraWarning: 1
